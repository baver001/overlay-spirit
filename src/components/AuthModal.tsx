...
const AuthModal: React.FC<AuthModalProps> = ({ 
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-md bg-surface-1 border-border text-foreground">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="space-y-2">
            <Label htmlFor="email" className="text-foreground/80">{t('common.email')}</Label>
            <div className="relative">
              ...
              <Input
                ...
                className="pl-10 bg-surface-2 border-border text-foreground placeholder:text-muted-foreground focus:border-primary"
                disabled={loading}
              />
            </div>
          </div>
          ...
          <div className="space-y-2">
            <Label htmlFor="password" className="text-foreground/80">{t('common.password')}</Label>
            <div className="relative">
              ...
              <Input
                ...
                className="pl-10 pr-10 bg-surface-2 border-border text-foreground placeholder:text-muted-foreground focus:border-primary"
                disabled={loading}
              />
              <button
                type="button"
          ...
          {mode === 'register' && (
            <div className="space-y-2">
              <Label htmlFor="confirmPassword" className="text-foreground/80">{t('common.confirm_password')}</Label>
              <div className="relative">
                <Lock className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-muted-foreground" />
                <Input
                  id="confirmPassword"
          ...
          <Button
            type="submit"
            disabled={loading}
            className="w-full bg-brand-gradient hover:opacity-90 text-white border-0 py-5 rounded-full shadow-glow-brand transition-opacity"
          >
            {loading ? (
        ...
        <div className="relative my-4">
          ...
          <div className="relative flex justify-center text-xs uppercase">
            <span className="bg-surface-1 px-2 text-muted-foreground">{t('common.or')}</span>
          </div>
        </div>
        ...
        <div className="space-y-2">
          <Button
            ...
            disabled={loading}
            className="w-full bg-white/5 border-border text-foreground hover:bg-white/10 hover:text-foreground"
          >
